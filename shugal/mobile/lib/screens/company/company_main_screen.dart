...
import 'company_interview_screen.dart';
import 'company_recruit_screen.dart';
...
class _CompanyMainScreenState extends State<CompanyMainScreen> {
  ...
  void initState() {
    ...
    _screens = [
      ...
      const CompanyInterviewScreen(),
      const CompanyRecruitScreen(),
      const ProfileScreen(),
    ];
  }
  ...
  Widget _buildBottomNavigationBar(AppLocalizations l10n) {
    return CurvedNavigationBar(
      ...
      items: [
        ...
        _navItem(
          iconPath: 'assets/images/icons/briefcase.png',
